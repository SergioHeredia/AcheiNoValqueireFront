...
<div class="card-body p-sm-12 ">
    <div class="row">
        <div class="col-12 col-lg-6 col-md-12 col-sm-12 p-xl-3  text-center"><img src="/assets/img/basic/logo.png" alt="Acheio no Valqueire" style="max-width: 296; max-height:192;"/></div>
